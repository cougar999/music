...
<div class="col-xs-12 col-md-4 col-lg-3 mb20">
	<div class="view overlay zoom">
		<a href="<?= $baseUrl ?>/site/album-view?id=<?= $model->id ?>" target="_blank"><img src="<?= $baseurl . $img_url ?>" alt="<?= $imgfilename ?>" title="<?= $model->album_name ?>" class="img-fluid z-depth-2"></a>
		<div class="rgba-blue-light mask flex-center waves-effect waves-light">
			<h5>
				<a href="<?= $baseUrl ?>/site/album-view?id=<?= $model->id ?>" target="_blank"><?= StringHelper::truncate($model->album_name, 40, '...', null, true) ?></a>
